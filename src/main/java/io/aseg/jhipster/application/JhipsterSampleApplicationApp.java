package io.aseg.jhipster.application;

import io.aseg.jhipster.application.config.ApplicationProperties;
import io.aseg.jhipster.application.config.DefaultProfileUtil;
